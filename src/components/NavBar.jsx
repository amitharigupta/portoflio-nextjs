...
import { TwitterIcon, GithubIcon, LinkedInIcon, PinterestIcon, DribbbleIcon, MoonIcon, SumIcon } from "@/components/Icons";
...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-meduim flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 mx-3">
            <TwitterIcon />
          </motion.a>
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 mx-3 bg-light rounded-full">
            <PinterestIcon />
          </motion.a>
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 mx-3 bg-light rounded-full dark:bg-dark">
            <GithubIcon />
          </motion.a>
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 ml-3">
            <LinkedInIcon />
          </motion.a>

          <button onClick={() => setMode(mode && mode === "light" ? "dark" : "light")}
            className={`ml-3 flex items-center justify-center rounded-full p-1 ${mode && mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}`} >
            {
              mode && mode === "dark" ? <SumIcon className={"fill-dark"} /> : <MoonIcon className={"fill-dark"} />
            }
          </button>
        </nav>
      </div>

      {
        ...
        <nav className="flex items-center flex-col justify-center">
          ...
          {/* <CustomMobileLink href={"/testimonials"} title={"Testimonials"} className="" toggle={handleClick} /> */}
        </nav>
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mr-3">
            <DribbbleIcon />
          </motion.a>
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 mx-3 sm:mx-1">
            <TwitterIcon />
          </motion.a>
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 mx-3 bg-light rounded-full">
            <PinterestIcon />
          ...
          <motion.a href={"https://twitter.com"} target="_blank" whileHover={{ y: -2 }} className="w-6 ml-3 sm:mx-1">
            <LinkedInIcon />
          </motion.a>
